 ...
 * ------------------------------------------------------------------ 
 * 2014-1-23    mawenqiang       1.0        1.0 Version 
 * </pre>
 */
...
public class FileOperateUtil {
	   ...
	   private static final String UPLOADDIR = "uploadResume/";
...
public static void download(HttpServletRequest request,  
        ...
        String realName,String downPath) throws Exception {  
		response.setContentType("text/html;charset=UTF-8");  
		request.setCharacterEncoding("UTF-8");  
        BufferedInputStream bis = null;  
        BufferedOutputStream bos = null;  
  
        String downLoadPath = downPath + System.getProperty("file.separator") + storeName;  
	...
	//获取某目录下文件的文件名
	public List<String> getFileNameOfFold(String path) {
